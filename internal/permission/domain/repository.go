...
type PermissionRepository interface {
	...
	DeleteByGroupAndResource(ctx context.Context, groupID, resource string) error
	DeleteByUserAndResource(ctx context.Context, userID, resource string) error
}
...
type ViewProfileRepository interface {
	...
	FindByGroupIDs(ctx context.Context, groupIDs []string) ([]ViewProfile, error)
	Delete(ctx context.Context, id string) error
}
